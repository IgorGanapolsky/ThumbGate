...
test('npm package ships a slim runtime boundary instead of repo/dev surfaces', () => {
  ...
  // Bumped 250 → 251 (2026-05-13) to ship scripts/public-rate-limiter.js,
  // which src/api/server.js imports at startup for the public HTTP edge.
  // Bumped 251 → 252 (2026-05-13) after merging main, which ships
  // public/federal.html, the

...
test('npm package ships a slim runtime boundary instead of repo/dev surfaces', () => {
  ...
  // Bumped 3.44 MB -> 3.45 MB (2026-05-05) for the compact answer-engine
  // pre-action-check tools guide blueprint plus public hub links. Observed
  // unpacked size is ~3.444 MB; keep the margin narrow.
  assert.ok(

...
test('npm package ships a slim runtime boundary instead of repo/dev surfaces', () => {
  ...
  // Bumped 3.95 MB -> 3.97 MB (2026-06-01) for the `setup-vertex` CLI command
  // (bin/cli.js + cli-schema.js) shipped alongside the action-loop runtime after
  // merging main. Observed package is ~3.956 MB.
  assert.ok(

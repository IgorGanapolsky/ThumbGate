...
const EXPECTED_ARTIFACTS = [
  ...
  'chatgpt-product-feed-readiness-pack.md',
  'chatgpt-product-feed-readiness-pack.json',
  'chatgpt-product-feed.csv',
  'chatgpt-product-feed-conversions.csv',
  'chatgpt-product-feed-operator-queue.csv',

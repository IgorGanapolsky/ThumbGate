...
const EXPECTED_ARTIFACTS = [
  ...
  'local-first-ai-reliability-pack.md',
  'local-first-ai-reliability-pack.json',
  'local-first-ai-reliability-operator-queue.csv',
  'local-first-ai-reliability-channel-drafts.csv',

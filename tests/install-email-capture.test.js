...
describe('postinstall banner contains subscribe and managed-service affordances', () => {
  it('postinstall.js renders subscribe, guide, managed-gate pricing, and trial mentions', () => {

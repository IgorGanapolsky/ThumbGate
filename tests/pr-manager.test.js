...
test('PR Manager - allows green mainline PRs to request Trunk queue from BLOCKED state', async () => {
  const mockPr = {
    number: 129,
    title: 'Queued mainline PR',
    baseRefName: 'main',
    mergeable: 'MERGEABLE',
    mergeStateStatus: 'BLOCKED',
    isDraft: false,
...
test('PR Manager - canRequestTrunkQueue only accepts MERGEABLE mainline BLOCKED PRs', () => {
  assert.equal(canRequestTrunkQueue({
    baseRefName: 'main',
    mergeable: 'MERGEABLE',
    mergeStateStatus: 'BLOCKED',
  }), true);
...
test('PR Manager - managePrs queues green BLOCKED mainline PRs through Trunk', async () => {
  const mockPr = {
    number: 284,
    title: 'Repo-wide queued PR',
    baseRefName: 'main',
    mergeable: 'MERGEABLE',
    mergeStateStatus: 'BLOCKED',
    isDraft: false,

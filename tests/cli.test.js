...
describe('bin/cli.js', () => {
  ...
  test('help all exits 0 and lists the full subcommand surface', () => {
    ...
    const expected = [
      ...
      'deepseek-v4-runtime-guardrails', 'nvidia-specdecode-al-doctor', 'risk', 'export-dpo',
      'deepseek-v4-runtime-guardrails', 'package-manager-honesty-doctor', 'risk', 'export-dpo',

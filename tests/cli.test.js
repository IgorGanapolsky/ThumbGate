...
describe('bin/cli.js', () => {
  ...
  test('pro command prints truthful local-first Pro offer info when unlicensed', () => {
    ...
    assert.match(result.stdout, /Pro: \$19\/mo self-serve/i);
  ...
  test('pro command includes hosted link', () => {
    ...
    assert.ok(result.stdout.includes('Pro: $19/mo self-serve'), 'Pro command should advertise self-serve Pro and unavailable hosted team features');

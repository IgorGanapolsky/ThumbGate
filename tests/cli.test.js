...
describe('bin/cli.js', () => {
  ...
  test('help all exits 0 and lists the full subcommand surface', () => {
    ...
    const expected = [
      ...
      'package-manager-honesty-doctor', 'openui-catalog-compose-honesty', 'allowlist-bridge-honesty', 'cobble-hot-store-split', 'token-shunt-honesty', 'typesafe-typed-questions', 'colab-compute-honesty', 'risk', 'export-dpo',

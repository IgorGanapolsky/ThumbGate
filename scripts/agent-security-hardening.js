...
const PROFILE_ALLOWLISTS = {
  essential: new Set(['capture_feedback', 'recall', 'search_lessons', 'search_rlhf', 'prevention_rules', 'enforcement_matrix', 'feedback_stats', 'estimate_uncertainty', 'org_dashboard', 'set_task_scope', 'get_scope_state', 'approve_protected_action']),
  readonly: new Set(['recall', 'feedback_summary', 'search_lessons', 'verify_claim', 'gate_stats', 'search_rlhf', 'feedback_stats', 'estimate_uncertainty', 'org_dashboard', 'get_scope_state']),
  ...
  commerce: new Set(['capture_feedback', 'recall', 'search_rlhf', 'commerce_recall', 'track_action', 'verify_claim', 'feedback_stats', 'set_task_scope', 'get_scope_state', 'approve_protected_action']),
};

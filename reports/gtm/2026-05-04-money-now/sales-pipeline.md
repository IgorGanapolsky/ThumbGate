...
Updated: 2026-05-26T22:40:43.312Z
...
### aiventyx_qaiser_marketplace_listings
- Stage: replied
- Offer: aiventyx_distribution
- Repo/account: Aiventyx
- Contact: qaisermehdi3@gmail.com
- Concrete offer: Submit ThumbGate Free, Pro, and Teams listings under AI Coding with tracked ThumbGate URLs.
- Proof rule: Do not claim Aiventyx-side clicks until Qaiser confirms click tracking is live; use ThumbGate UTMs for attribution now.
- Outreach draft: Reply: confirm UTMs as source of truth, wait for old proxy Free listing removal, submit all three listings, and send live links after submission.
...
### aiventyx_qaiser_marketplace
- Stage: contacted
- Offer: aiventyx_marketplace_free_pro_teams
- Repo/account: Aiventyx
- Contact: qaisermehdi3@gmail.com
- Concrete offer: Submit/approve Free, Pro, and Teams listings with tracked CTAs.
- Proof rule: Use marketplace URLs and UTM data after listings are live.
- Outreach draft: n/a
- Pain-confirmed follow-up: n/a
...
### github_baseinfinity_claude_sdlc_wizard
- Stage: contacted
- Offer: pro_self_serve
- Repo/account: https://github.com/BaseInfinity/claude-sdlc-wizard
- Contact: @BaseInfinity
- Concrete offer: I will harden one AI-agent workflow for you.
- Proof rule: Use proof pack only after the buyer confirms pain.
- Outreach draft: Hey @BaseInfinity, saw you're building around `claude-sdlc-wizard`. If you want the clean self-serve tool path first, start with the proof-backed setup guide: https://thumbgate-production.up.railway.app/guide. If one repeated agent mistake is still slowing the workflow down after that, Pro is the clean next step.

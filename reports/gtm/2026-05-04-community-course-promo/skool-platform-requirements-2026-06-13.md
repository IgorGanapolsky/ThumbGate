# Skool Platform Requirements — 2026-06-13 Refresh
...
Re-verified from Skool official help sources on 2026-06-13, with public-source spot check completed again at `2026-06-13T13:20:04Z` and re-confirmed again before `2026-06-13T14:20:56Z`:
...
- Skool account-security guidance published `June 8, 2026` explicitly says creators must not share credentials or login codes, which means any authenticated Operator Lab verification should stay session-local instead of trying to externalize account access.
- Public-source spot check was re-confirmed again before `2026-06-13T15:20:14Z`; no requirement delta was detected versus the earlier June 13 refresh.
- Public-source spot check was re-confirmed again before `2026-06-13T16:21:48Z`; no requirement delta was detected versus the earlier June 13 refresh.
- Public-source spot check was re-confirmed again before `2026-06-13T17:21:55Z`; no requirement delta was detected versus the earlier June 13 refresh.
- Public-source spot check was re-confirmed again before `2026-06-13T18:24:04Z`; no requirement delta was detected versus the earlier June 13 refresh.
- Official-source spot check via Skool Help public pages was re-confirmed again at `2026-06-13T19:25:39Z`; no requirement delta was detected versus the earlier June 13 refresh.
- Official-source spot check via Skool Help public pages was re-confirmed again in this run on `2026-06-13`; no requirement delta was detected versus the earlier June 13 refresh.
- Official-source spot check via Skool Help public pages was re-confirmed again at `2026-06-13T23:26:26Z`; no requirement delta was detected versus the earlier June 13 refresh.
...
- The local runtime can now read the public Skool page headlessly again, but the current baseline is weak: `Members: 1` and `Visible posts on page: 0` as of `2026-06-13T11:17:53Z`.
...
- Public shell verification was re-confirmed again at `2026-06-13T23:26:26Z`: `Community`, `Classroom`, `Calendar`, `Members`, `Leaderboards`, `About`, `JOIN GROUP`, `1 Member`, and the placeholder line `This is the start of something special`.
- The same public page currently exposes the placeholder line `This is the start of something special`, which is evidence that public feed depth remains thin even though the shell is live.
- The same public page payload also currently exposes `public: true` and `archived: true` in the group metadata. This is evidence of a potential Operator Lab state problem, but it still needs logged-in verification before treating it as the cause of weak discovery traction.
...
- [Account Security](https://help.skool.com/article/186-account-security)

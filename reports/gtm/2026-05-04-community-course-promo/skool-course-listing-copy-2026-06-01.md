# Skool Listing Copy — ThumbGate Operator Lab (2026-06-01)
...
- solo operators shipping production workflows with AI agents
- consultancies delivering agent workflows to clients
- platform teams standardizing one risky workflow with approval boundaries

## Outcomes (honest, measurable)

- map one workflow and identify the repeat failure points
- wire one prevention rule into the agent loop (Infrastructure Firewall)
- produce a proof pack grounded in `docs/VERIFICATION_EVIDENCE.md` and `proof/*` reports
- learn how to escalate: self-serve Pro vs Diagnostic vs Sprint

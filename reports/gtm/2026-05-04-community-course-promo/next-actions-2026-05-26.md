# Next Actions — Skool Operator Lab (2026-05-26)
...
- Media-backed promo preview (safe; no publish): `reports/gtm/2026-05-04-community-course-promo/zernio-preview-operator-lab-2026-05-26.json`
...
- Attendee outreach drafts (prep only): `reports/gtm/2026-05-04-community-course-promo/operator-lab-attendee-queue-2026-05-26.md`
...
- GitHub Actions: run `.github/workflows/thumbgate-creator-platform-promo.yml` with `mode=preview` and `offer=operator-lab`.

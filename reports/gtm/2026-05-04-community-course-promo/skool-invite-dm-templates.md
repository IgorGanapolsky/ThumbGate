# Skool — Invite / DM Templates (Approval-Ready)

Generated: 2026-05-04

Do not send automatically. These are drafts to copy/paste after explicit approval.

## Invite DM (warm, non-sales)

Hey — I’m running a free Skool group for operator-grade AI-agent reliability: **ThumbGate Operator Lab**.

If you have one repeated Claude Code / Codex / Cursor workflow failure (context drift, unsafe tool calls, broken PRs, deploy mistakes), post it and we’ll help turn it into a **Pre-Action Gate** you can enforce.

Group: https://www.skool.com/thumbgate-operator-lab-6000

## Invite DM (warm, with diagnostic mention)
...
## Comment reply (for public posts)

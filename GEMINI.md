...
- **Rule [auto-rest-fallback]**: Auto-promoted repeated pattern: "stdin test" (50 occurrences in 30 days)
...
- **Rule [auto-promoted-mqq83gpd-0]**: NEVER MISTAKE: This is a test failure
- **Rule [auto-promoted-mqq84cn8-0]**: NEVER repeated problem context string

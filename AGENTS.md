...
- **Rule [auto-rest-fallback]**: Auto-promoted repeated pattern: "stdin test" (51 occurrences in 30 days)
...
- **Rule [auto-promoted-mqqtnlm2-0]**: NEVER MISTAKE: This is a test failure
- **Rule [auto-promoted-mqqto7jk-0]**: NEVER repeated problem context string

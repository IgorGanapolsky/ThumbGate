...
- **Rule [auto-rest-fallback]**: Auto-promoted repeated pattern: "stdin test" (57 occurrences in 30 days)
...
- **Rule [auto-computer-use-entity-customer-permanent-rule-revenu]**: Auto-promoted repeated pattern: "User explicitly set permanent rule: never pay for or depend on DirectSocial; post everywhere manually using Computer Use/brows" (1 occurrences in 30 days)
...
- **Rule [auto-entity-revenue]**: Auto-promoted repeated pattern: "ThumbGate captured DirectSocial social/revenue posting failures but default warn-by-default enforcement did not prevent the ag" (1 occurrences in 30 days)

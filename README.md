...
- **Free forever** — 2 feedback captures/day (10 total) and up to 3 auto-promoted prevention rules. Enough for daily solo safety.
- **[→ Start Pro — $19/mo or $149/yr](https://thumbgate.ai/checkout/pro?utm_source=github&utm_medium=readme)** — unlimited rules, history-aware lessons, feedback sessions, the dashboard, and DPO export.
- **Enterprise** (custom, scoped after intake) — shared hosted lesson DB, org dashboard, and org-wide enforcement.

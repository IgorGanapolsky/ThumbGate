    ...
    if (isGetLikeRequest && pathname === '/checkout/pro') {
      ...
      if (!isConfirmedCheckout) {
        ...
        const html = renderCheckoutIntentPage({
          workflowIntakeHref,
          confirmHiddenParams,
          gaMeasurementId: hostedConfig.gaMeasurementId,
          posthogApiKey: hostedConfig.posthogApiKey,
        });

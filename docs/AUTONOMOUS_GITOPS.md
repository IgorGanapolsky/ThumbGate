...
- CTA: https://rlhf-feedback-loop-production.up.railway.app/checkout/pro
- Outreach draft: Hey @estebamod, saw you're building around `osmmcp`. If you're hitting "Claude amnesia" or losing architectural constraints to auto-compaction between sessions, the self-serve path is compaction-safe memory with ThumbGate Pro at $19/mo or $149/yr: https://rlhf-feedback-loop-production.up.railway.app/checkout/pro Commercial truth: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md. Proof pack: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md.

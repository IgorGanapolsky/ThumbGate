...
- Transport: local stdio MCP server launched via `npx -y mcp-memory-gateway@0.9.4 serve`
...
- Local install path: `claude mcp add rlhf -- npx -y mcp-memory-gateway@0.9.4 serve`

...
- `local-first-ai-reliability-pack.md` for the local-first AI inference guide, ThumbGate mapping, and paid-intent CTAs
- `local-first-ai-reliability-pack.json` for the same local-first AI reliability pack in machine-readable form
- `local-first-ai-reliability-operator-queue.csv` for guide publishing, social commentary, and sprint-routing next asks
- `local-first-ai-reliability-channel-drafts.csv` for LinkedIn, Reddit, and qualified follow-up drafts

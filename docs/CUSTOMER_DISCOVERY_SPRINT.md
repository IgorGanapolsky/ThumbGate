...
- `operator-send-now.md` for a one-file markdown send queue with ranked drafts plus sales-pipeline log commands
...
- `mcp-directory-surfaces.csv` for one-sheet MCP directory submission fields, tracked guide links, and paste-ready copy

...
npx -y thumbgate@1.27.7 --version
npx -y thumbgate@1.27.7 setup-vertex --dry-run
npx -y thumbgate@1.27.7 feedback-self-test --help
```
...
- Published package was verified from npm after release: `thumbgate@1.27.7`.
...
npx -y thumbgate@1.27.7 help break-glass
npx -y thumbgate@1.27.7 break-glass --reason="published artifact verification" --json
```
...
- Published-artifact dogfood passed for `npx -y thumbgate@1.27.7 help break-glass`.
- Published-artifact dogfood passed for `npx -y thumbgate@1.27.7 break-glass --reason="published artifact verification" --json`, returning a `300000` ms TTL and settings-only recovery globs.
...
- Portable docs and adapter examples now use the version-pinned launcher `npx -y thumbgate@1.27.7 serve` instead of an unpinned `npx` call that can be shadowed by stale local installs.
...
- Switched the Cursor launcher to the portable published package entrypoint `npx -y thumbgate@1.27.7 serve` instead of any checkout-local absolute path.

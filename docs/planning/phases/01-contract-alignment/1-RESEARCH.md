...
- `docs/planning/ROADMAP.md` — confirmed "54 for thumbgate" refers to node --test count (52 test:api + 2 test:proof)
- `docs/planning/REQUIREMENTS.md` — confirmed CNTR-01, CNTR-02, CNTR-03 scope

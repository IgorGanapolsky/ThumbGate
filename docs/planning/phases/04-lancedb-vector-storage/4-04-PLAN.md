...
@docs/planning/phases/04-lancedb-vector-storage/4-RESEARCH.md
@scripts/prove-adapters.js
@docs/planning/phases/04-lancedb-vector-storage/4-01-SUMMARY.md
@docs/planning/phases/04-lancedb-vector-storage/4-02-SUMMARY.md
@docs/planning/phases/04-lancedb-vector-storage/4-03-SUMMARY.md
</context>
...
<task type="auto">
  ...
  <action>
    ...
    STEP 2: Update /Users/ganapolsky_i/workspace/git/igor/ThumbGate/docs/planning/REQUIREMENTS.md — mark VEC-01 through VEC-05 as complete:
    Change:
    ```
    - [ ] **VEC-01**: ...
    - [ ] **VEC-02**: ...
  ...
  <verify>
    ...
    grep "\- \[x\] \*\*VEC" docs/planning/REQUIREMENTS.md | wc -l
    Expected: 5
  </verify>
  <done>
...
5. `grep "\[x\].*VEC" docs/planning/REQUIREMENTS.md | wc -l` → 5
</verification>
...
<output>
After completion, create `docs/planning/phases/04-lancedb-vector-storage/4-04-SUMMARY.md`
</output>

...
```bash
claude mcp add rlhf -- npx -y mcp-memory-gateway@0.7.2 serve
```
...
Current self-serve commercial offer: Pro ($49 one-time): https://iganapolsky.gumroad.com/l/tjovof
...
- **stdio** (primary): `npx -y mcp-memory-gateway@0.7.2 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

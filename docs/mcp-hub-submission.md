...
```bash
claude mcp add thumbgate -- npx -y thumbgate@1.14.1 serve
```
...
- **stdio** (primary): `npx -y thumbgate@1.14.1 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

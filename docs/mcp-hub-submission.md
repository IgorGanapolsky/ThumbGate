...
```bash
claude mcp add thumbgate -- npx -y thumbgate@1.27.8 serve
```
...
- **stdio** (primary): `npx -y thumbgate@1.27.8 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

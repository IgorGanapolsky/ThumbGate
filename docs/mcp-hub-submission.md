...
```bash
claude mcp add thumbgate -- npx -y thumbgate@0.9.12 serve
```
...
- **stdio** (primary): `npx -y thumbgate@0.9.12 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

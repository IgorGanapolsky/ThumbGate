...
```bash
claude mcp add thumbgate -- npx -y thumbgate@1.8.0 serve
```
...
- **stdio** (primary): `npx -y thumbgate@1.8.0 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

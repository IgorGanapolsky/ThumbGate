...
```bash
claude mcp add thumbgate -- npx -y thumbgate@1.5.6 serve
```
...
- **stdio** (primary): `npx -y thumbgate@1.5.6 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

...
```bash
claude mcp add thumbgate -- npx -y thumbgate@0.9.11 serve
```
...
- **stdio** (primary): `npx -y thumbgate@0.9.11 serve` — version-pinned portable MCP launcher for Claude Code desktop and CLI

# Show HN: ThumbGate – Persistent memory for AI coding agents
...
The self-hosted version is free. Install in 30 seconds: npx mcp-memory-gateway serve. It works with Claude Code, Codex CLI, Gemini CLI, Amp, and Cursor. All data stays local. The public self-serve commercial offer today is Pro at $49 one-time via https://rlhf-feedback-loop-production.up.railway.app/checkout/pro, which gives every licensed user a personal local dashboard. Hosted rollout help remains optional at https://rlhf-feedback-loop-production.up.railway.app

...
- Workflow-control targets in backstop: 10
- Business-system targets in backstop: 8
...
- Evidence: 10 workflow-control target(s), 8 business-system target(s), and 13 sprint-fit target(s) currently favor a workflow-hardening motion over a generic plugin pitch.

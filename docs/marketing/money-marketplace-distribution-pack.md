...
- Price anchor: $19/mo or $149/yr Pro follow-on; Gumroad product can be a paid kit or free lead magnet.
- Primary CTA: https://thumbgate.ai/guide?utm_source=gumroad&utm_medium=marketplace&utm_campaign=gumroad_pro_listing&utm_content=distribution_pack&campaign_variant=pro&offer_code=GUMROAD-PRO&cta_id=gumroad_pro_cta&cta_placement=listing_copy
- Current path: Sell a downloadable Workflow Hardening Kit and route serious buyers to Pro checkout or sprint intake from the product receipt and update emails.
- Source evidence: https://gumroad.com/features | https://gumroad.com/pricing
- Proof links: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md | https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md

Listing copy:
> A practical kit for developers who want one repeated AI-agent mistake to become an enforceable pre-action gate, with a proof checklist and upgrade path to ThumbGate Pro.
...
- Price anchor: Sprint-led service motion; Team at $49/seat/mo after qualification.
- Primary CTA: https://thumbgate.ai/?utm_source=gohighlevel&utm_medium=marketplace&utm_campaign=gohighlevel_sprint_listing&utm_content=distribution_pack&campaign_variant=sprint&offer_code=GOHIGHLEVEL-SPRINT&cta_id=gohighlevel_sprint_cta&cta_placement=listing_copy#workflow-sprint-intake
- Current path: Start as a private Marketplace app or snapshot for agency operators, then submit publicly after OAuth, listing, security, and support materials are stable.
- Source evidence: https://marketplace.gohighlevel.com/docs/oauth/CreateMarketplaceApp/ | https://help.gohighlevel.com/support/solutions/articles/155000000136-how-to-get-started-with-the-developer-s-marketplace
- Proof links: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md | https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md

Listing copy:
> ThumbGate gives agency automations a Reliability Gateway: repeated failures become shared pre-action gates, every risky automation gets evidence, and client-facing workflows keep an audit trail.

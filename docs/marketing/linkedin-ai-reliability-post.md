...
2. Validate whether it is specific enough to keep
...
Local-first. Auditable. Built for Claude Code, Codex, Cursor, and agent-heavy engineering workflows.
```
...
- Headline: The loop
- Body: Capture feedback. Validate it. Retrieve the right lesson. Generate prevention rules. Verify the result.
- Footer: Build -> learn -> verify -> improve

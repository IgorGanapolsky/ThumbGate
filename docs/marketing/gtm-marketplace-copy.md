...
- Workflow control surfaces (6): The strongest cold targets expose workflow control surfaces where repeated failures and bad handoffs are visible and expensive. Examples: montenegronyc/backporcher, Adqui9608/ai-code-review-agent, hey-api/openapi-ts
- Self-serve agent tooling (5): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: Adqui9608/ai-code-review-agent, hey-api/openapi-ts, disler/claude-code-hooks-multi-agent-observability
...
- Sample targets: montenegronyc/backporcher, Adqui9608/ai-code-review-agent, hey-api/openapi-ts
...
- Sample targets: Adqui9608/ai-code-review-agent, hey-api/openapi-ts, disler/claude-code-hooks-multi-agent-observability
...
- disler/claude-code-hooks-multi-agent-observability (cold): Target looks like a local hook, plugin, or config surface, so start with the setup guide and Pro follow-on before pitching a sprint.

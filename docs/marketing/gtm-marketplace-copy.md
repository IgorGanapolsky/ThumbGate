...
- Self-serve agent tooling (4): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: Abhi268170/Stagix, SethGammon/Citadel, zaxbysauce/opencode-swarm

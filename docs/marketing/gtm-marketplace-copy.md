...
- Workflow control surfaces (5): The strongest cold targets expose workflow control surfaces where repeated failures and bad handoffs are visible and expensive. Examples: DGouron/review-flow, nihannihu/Omni-SRE, manki-review/manki
...
- Business-system workflow approvals (3): Targets wiring agents into Jira, GitHub, ServiceNow, Slack, or CRM systems need approval boundaries, rollback safety, and proof. Examples: DGouron/review-flow, nihannihu/Omni-SRE, manki-review/manki
- Self-serve agent tooling (2): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: zaxbysauce/opencode-swarm, swarmclawai/swarmvault

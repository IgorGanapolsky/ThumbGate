...
- Workflow control surfaces (5): The strongest cold targets expose workflow control surfaces where repeated failures and bad handoffs are visible and expensive. Examples: dolutech/engine_context, kamaldhingra/AI-Agents-QA-Automation, Adqui9608/ai-code-review-agent
...
- Business-system workflow approvals (4): Targets wiring agents into Jira, GitHub, ServiceNow, Slack, or CRM systems need approval boundaries, rollback safety, and proof. Examples: dolutech/engine_context, kamaldhingra/AI-Agents-QA-Automation, Adqui9608/ai-code-review-agent
- Self-serve agent tooling (3): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: Habitat-Thinking/ai-literacy-superpowers, zaxbysauce/opencode-swarm, mann1x/claude-hooks
...
- Sample targets: dolutech/engine_context, kamaldhingra/AI-Agents-QA-Automation, Adqui9608/ai-code-review-agent
...
- Sample targets: Habitat-Thinking/ai-literacy-superpowers, zaxbysauce/opencode-swarm, mann1x/claude-hooks
...
- Habitat-Thinking/ai-literacy-superpowers (cold): Target looks like a local hook, plugin, or config surface, so start with the setup guide and Pro follow-on before pitching a sprint.

...
- Self-serve agent tooling (3): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: bherald/personal-life-os-core, berkcangumusisik/repo-seatbelt, zaxbysauce/opencode-swarm
...
- Sample targets: bherald/personal-life-os-core, berkcangumusisik/repo-seatbelt, zaxbysauce/opencode-swarm

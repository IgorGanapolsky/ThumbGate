...
- Production rollout proof (4): Platform and production workflows need proof before agents touch releases, incidents, or compliance-sensitive systems. Examples: WagnerAgent/awesome-mcp-servers-devops, bjeans/homelab-mcp, gensecaihq/MCP-Developer-SubAgent
- Workflow control surfaces (2): The strongest cold targets expose workflow control surfaces where repeated failures and bad handoffs are visible and expensive. Examples: freema/mcp-jira-stdio, salacoste/mcp-n8n-workflow-builder

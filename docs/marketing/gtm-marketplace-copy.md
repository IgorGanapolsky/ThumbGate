...
- Workflow control surfaces (5): The strongest cold targets expose workflow control surfaces where repeated failures and bad handoffs are visible and expensive. Examples: dolutech/engine_context, Abhi268170/Stagix, BaseInfinity/claude-sdlc-wizard
- Self-serve agent tooling (5): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: Abhi268170/Stagix, alirezarezvani/claude-skills, BaseInfinity/claude-sdlc-wizard
...
- Sample targets: dolutech/engine_context, Abhi268170/Stagix, BaseInfinity/claude-sdlc-wizard
...
- Sample targets: Abhi268170/Stagix, alirezarezvani/claude-skills, BaseInfinity/claude-sdlc-wizard

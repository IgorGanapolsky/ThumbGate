...
- Self-serve agent tooling (6): Some buyers are closer to local hook, plugin, and config adoption than a services sprint, so the guide-to-Pro lane should stay visible. Examples: 777genius/claude-notifications-go, bovinphang/frontend-craft, hatch3r/hatch3r
...
- Production rollout proof (4): Platform and production workflows need proof before agents touch releases, incidents, or compliance-sensitive systems. Examples: 777genius/claude-notifications-go, bovinphang/frontend-craft, hatch3r/hatch3r
...
- Sample targets: 777genius/claude-notifications-go, bovinphang/frontend-craft, hatch3r/hatch3r
...
- sravan27/context-os (cold): Target looks like a local hook, plugin, or config surface, so start with the setup guide and Pro follow-on before pitching a sprint.
- 777genius/claude-notifications-go (cold): Lead with one business-system workflow that needs approval boundaries, rollback safety, and proof.

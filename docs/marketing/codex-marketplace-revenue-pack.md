...
Updated: 2026-05-03T18:21:15.678Z

This is a sales operator artifact. It is not proof of installs, revenue, or marketplace approval by itself.

## Objective
Turn Codex plugin interest into proof-backed installs, Pro checkout starts, and qualified workflow sprint conversations.
...
- Versioned URL: https://github.com/IgorGanapolsky/ThumbGate/releases/download/v1.16.11/thumbgate-codex-plugin-v1.16.11.zip
...
- Proof: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md
- Support: https://github.com/IgorGanapolsky/ThumbGate/blob/main/plugins/codex-profile/README.md
- Proof links: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md | https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md

### Repo-local Codex profile docs
- URL: https://github.com/IgorGanapolsky/ThumbGate/blob/main/plugins/codex-profile/README.md
- Operator use: Technical proof surface for install steps, runtime update policy, and self-contained bundle contents.
- Buyer signal: Technical evaluators comparing the plugin surface versus the manual MCP path.
- Evidence source: plugins/codex-profile/README.md
- Proof: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md
- Support: https://github.com/IgorGanapolsky/ThumbGate/blob/main/plugins/codex-profile/INSTALL.md
- Proof links: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md | https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md
...
- URL: https://github.com/IgorGanapolsky/ThumbGate/blob/main/plugins/claude-codex-bridge/README.md
- Operator use: Cross-sell surface when a team already trusts Claude Code but wants a Codex review lane.
- Buyer signal: Teams that need second-pass review or adversarial review before broader rollout.
- Evidence source: plugins/claude-codex-bridge/README.md
- Proof: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md
- Support: https://github.com/IgorGanapolsky/ThumbGate/blob/main/plugins/claude-codex-bridge/README.md
- Proof links: https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/COMMERCIAL_TRUTH.md | https://github.com/IgorGanapolsky/ThumbGate/blob/main/docs/VERIFICATION_EVIDENCE.md

## Listing Copy
- Headline: Stop Codex from repeating the same tool mistake.
- Subhead: ThumbGate gives Codex an auto-updating MCP runtime, local-first feedback memory, and hard pre-action gates before risky commands, edits, or publishes run again.
- Short description: Auto-updating ThumbGate plugin for Codex. Capture thumbs-up/down feedback, turn repeated failures into Pre-Action Checks, and keep proof close to the install path.
- Proof bullets:
...
- Primary CTA: Download Codex plugin — https://github.com/IgorGanapolsky/ThumbGate/releases/latest/download/thumbgate-codex-plugin.zip

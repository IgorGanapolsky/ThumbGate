...
If you want a hosted dashboard with auto-gate promotion, multi-repo sync, and CI webhook ingestion, there is a [Pro tier at $49/mo](https://rlhf-feedback-loop-production.up.railway.app). But the local version handles the full feedback loop on its own.
